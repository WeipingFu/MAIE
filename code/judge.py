...
class JudgeAgent(Agent):
    ...
    def apply_one(self, gen_task:str, model_responses:list, round:int = 1, example_paths:list = None, pre_messages:list = None, prt:bool = False):
        resp = ''
...
if __name__ == "__main__":
    ...
    judge.apply_one(gen_task, model_responses, round=1, pre_messages=[], prt=True)